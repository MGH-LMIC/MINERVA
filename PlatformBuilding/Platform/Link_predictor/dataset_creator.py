...
class DatasetCreator:
    ...
    def preprocess_strengths(self, strengths, strength_th=0, training_type='regressor', train_val_ratio=0.8,
        ...
        self.intersections.index = self.intersections['id_microbe'].astype(str) + '_' + self.intersections['id_disease'].astype(str)
        indices_intersection = strengths.index.intersection(self.intersections.index)

        # Testing mask
        testing_mask = strengths.loc[indices_intersection]['id'].values.squeeze()
